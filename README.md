...
- [supabase.com](http://supabase.com/) > 프로젝트 > Authentication 메뉴 > Sign In / Providers 메뉴
  ...
  function AuthCallback() {
    ...
    return (
      ...
      >
        ...
        >
          <h2
            style={{ fontSize: '24px', fontWeight: '600', marginBottom: '24px', color: '#1f2937' }}
          >
            인증 페이지
          </h2>
        ...
        <div className="card" style={{ maxWidth: '400px', margin: '0 auto' }}>
          <form onSubmit={handleSubmit}>
            ...
            {emailCheckStatus === 'taken' && (
              ...
              >
                ❌ 이미 사용 중인 이메일입니다. 다른 이메일을 사용하거나 해당 이메일로
                로그인해주세요.
              </div>
            )}
            {nicknameCheckStatus === 'taken' && (

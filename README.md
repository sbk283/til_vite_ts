- 사용자가 내용 작성 중 이미지를 배치한다면
  ...
  3. 이미지를 배치하면 미리보기 url 을 생성한 후 보여주고
     1. img src="임시주소", 이미지 파일은 별도로 보관함.
     2. 사용자가 저장버튼 누르면 그때 storage 에 저장하고
     3. 저장이 성공되면 getURL로 주소 알아내고
     4. content 에 내용중 img src=”주소” 교체하고
     5. DB 에 저장한다.

## 1. Supabase Storage 설정

1. `todo-images 를 생성`합니다.

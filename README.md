...
CREATE POLICY "Public object access" ON storage.objects FOR ALL USING (bucket_id = 'profile-images');
```

### 2.1.1. Policy 오류 시 해결법

```sql
DROP POLICY "Public object access" ON storage.objects;
